    	...
    	<div class="wrapper clearfix">        	
			<div class="right-col">	
				<div class="breadcrumb clearfix">
					...
					<a href="#">صفحه اصلی</a>&nbsp;&raquo;&nbsp;<a href="#" class="current-page">هنری</a> 
				</div><!--end:breadcrumb-->
				<section class="entry-box clearfix">
					<h1 class="entry-title">

لورم ایپسوم یا طرح‌نما</h1>
					<span class="entry-meta">در:&nbsp;</span><a class="meta-data" href="#">سیاسی</a>
					<span class="entry-meta">&nbsp;&nbsp;|&nbsp;&nbsp;</span><span class="meta-data">07.08.2012</span>
					<span class="entry-meta">&nbsp;&nbsp;|&nbsp;&nbsp;توسط:&nbsp;</span><a class="meta-data" href="#">ادمین</a>
					<iframe class="border-box" src="http://player.vimeo.com/video/46163823?title=0&amp;portrait=0&amp;color=ff0011" width="100%" height="383" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
								...
								<ul class="related-news clearfix">
									<li>
										<article class="feature-item clearfix">
											<div class="video-thumb">
												<img class="responsive-img" src="placeholders/168x171/168x171-1.jpg" alt="" />
											...
											<div class="entry-content">
												<span class="entry-meta">در:&nbsp;</span><a class="meta-data" href="#">سیاسی</a>
												<span class="entry-meta">&nbsp;&nbsp;|&nbsp;&nbsp;</span><span class="meta-data">07.08.2012</span>
												<h4 class="entry-title"><a href="#">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</a></h4>
									...
									<li>
										<article class="feature-item clearfix">
											<div class="article-thumb">
												<a href="#" class="hover-effect link-icon">
													<img class="responsive-img" src="placeholders/168x171/168x171-2.jpg" alt="" />
												</a>
											</div><!--article-thumb-->											
											<div class="entry-content">
												<span class="entry-meta">در:&nbsp;</span><a class="meta-data" href="#">فرهنگی</a>
												<span class="entry-meta">&nbsp;&nbsp;|&nbsp;&nbsp;</span><span class="meta-data">07.08.2012</span>
												<h4 class="entry-title"><a href="#">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</a></h4>
												<p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
											</div><!--end:entry_content-->
									...
									<li>
										<article class="feature-item clearfix">
											<div class="article-thumb">
												<a href="#" class="hover-effect link-icon">
													<img class="responsive-img" src="placeholders/168x171/168x171-3.jpg" alt="" />
												</a>
											</div><!--article-thumb-->
											<div class="entry-content">
												<span class="entry-meta">در:&nbsp;</span><a class="meta-data" href="#">سیاسی</a>
									...
									<li>
										<article class="feature-item clearfix">
											<div class="video-thumb">
												<img class="responsive-img" src="placeholders/168x171/168x171-4.jpg" alt="" />
												<a class="play-icon" href="http://vimeo.com/46163823" rel="prettyPhoto" >
													<span class="black-overlay"></span>
												</a>
											</div><!--video-thumb-->
...
درباره نویسنده
					...
					<div class="entry-content clearfix">
						<strong class="author-name">بهروز امینی</strong>
						<a href="#">http://barnamenevisan.org</a>
...
3 نظر در این مقاله
							...
							<article class="comment-wrap clearfix"> 
								...
								<div class="comment-body">
									<div class="comment-meta">
										<span class="author">بهروز امینی</span>
										<span class="date">November 3, 2011 pm30 12:53</span>                                                
					...
					<div class="comment-pagination clearfix">
						<a href="#" class="prev page-numbers">&laquo; قبلی</a>
				...
				<div id="respond">
					<h3>پاسخ بگذار</h3>               
					<form id="comments-form" class="clearfix" action="http://kopatheme.com/demo/great-news/html/style-1/processForm.php" method="post">                
						<div class="comment-right">
							<p class="input-block">
								<label class="required" for="comment-name">نام:</label>
								<input class="valid" type="text" name="name" id="comment-name" value="">
							</p>
							<p class="input-block">
								<label class="required" for="comment-email">ایمیل:</label>
								<input type="email" class="valid" name="email" id="comment-email" value="">
							</p>
							<p class="input-block">                                                
								<label class="required" for="comment-url">وب سایت:</label>
								<input type="text" id="comment-url" value="" class="valid" name="url">                                                
							</p>
						</div>
						<div class="comment-left">
							<p class="textarea-block">                        
								<label class="required" for="comment-message">پیام:</label>
								<textarea rows="6" cols="88" id="comment-message" name="message"></textarea>
							</p>
						</div>
						<div class="clear"></div>
				...
				<ul id="widget-list-a">
					...
					<li>
						<aside class="widget clearfix">
							<h4 class="widget-title"><a href="#">سبک زندگی</a></h4>
							<article class="entry-box clearfix">
								<div class="video-thumb">
									<img class="responsive-img" src="placeholders/242x160/242x160-2.jpg" alt="" />
									<a class="play-icon" href="http://vimeo.com/46163823" rel="prettyPhoto" >
										<span class="black-overlay"></span>
									</a>
								</div><!--video-thumb-->
								<div class="entry-content">
									<span class="entry-meta">در:&nbsp;</span><a class="meta-data" href="#">سیاسی</a>
									<span class="entry-meta">&nbsp;&nbsp;|&nbsp;&nbsp;</span><span class="meta-data">07.08.2012</span>
									<span class="entry-meta">&nbsp;&nbsp;|&nbsp;&nbsp;توسط:&nbsp;</span><a class="meta-data" href="#">ادمین</a><h3 class="entry-title"><a href="#">

لورم ایپسوم یا طرح‌نما </a></h3>
									<p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است</p>
					...
					<li>
						<aside class="widget clearfix">
							<h4 class="widget-title">ردههای صفحه</h4>
							<div class="tag">
								<a href="#">وبلاگ</a>
								<a href="#">ورزشی</a>
								<a href="#">هنری</a>
					...
					<li>
						<aside class="widget clearfix">
							...
							<ul class="gallery clearfix">
								<li>										
									<a class="gallery-img" href="placeholders/124x124/124x124-1.jpg" rel="prettyPhoto" >
										<img class="responsive-img scale-hover" src="placeholders/124x124/124x124-1.jpg" alt="" />
									</a>
								</li>
								<li class="last">										
									<a class="gallery-img" href="placeholders/124x124/124x124-1.jpg" rel="prettyPhoto" >
										<img class="responsive-img scale-hover" src="placeholders/124x124/124x124-2.jpg" alt="" />
									</a>
								</li>
								<li>
									
									<a class="gallery-img" href="placeholders/124x124/124x124-1.jpg" rel="prettyPhoto" >
										<img class="responsive-img scale-hover" src="placeholders/124x124/124x124-3.jpg" alt="" />
									</a>
								</li>
								<li class="last">										
									<a class="gallery-img" href="placeholders/124x124/124x124-1.jpg" rel="prettyPhoto" >
										<img class="responsive-img scale-hover" src="placeholders/124x124/124x124-4.jpg" alt="" />
									</a>
								</li>
