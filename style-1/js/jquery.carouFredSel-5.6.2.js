...
(function($) {
	...
	$.fn.carouFredSel = function(options, configs) {
		...
		$cfs._cfs_init = function(o, setOrig, start) {
			...
			var dims = [
				['width'	, 'innerWidth'	, 'outerWidth'	, 'height'	, 'innerHeight'	, 'outerHeight'	, 'right', 'top'	, 'marginLeft'	, 0, 1, 2, 3],
				['height'	, 'innerHeight'	, 'outerHeight'	, 'width'	, 'innerWidth'	, 'outerWidth'	, 'top'	, 'right', 'marginBottom', 3, 2, 1, 0]
			];

			var dn = dims[0].length,
				dx = (opts.direction == 'left' || opts.direction == 'right') ? 0 : 1;
...
if (opts.responsive) {
	...
	opts[opts.d['width']] = visb * newS;
			...
			if (opts.align == 'bottom') 	opts.align = 'left';
		...
		$cfs._cfs_build = function() {
			...
			if (opts.usePadding) {
				$cfs.children().each(function() {
					var m = parseInt($(this).css(opts.d['marginLeft']));
					if (isNaN(m)) m = 0;
		...
		$cfs._cfs_bind_events = function() {
			...
			$cfs.bind(cf_e('slide_prev', conf), function(e, sO, nI) {
				...
				if (opts.usePadding) {
					...
					if (l_new.not(l_cur).length) {
			 			var a_cur = {};
			 				a_cur[opts.d['marginLeft']] = l_cur.data('cfs_origCssMargin');
					...
					if (l_new.not(l_old).length) {
						var a_old = {};
							a_old[opts.d['marginLeft']] = l_old.data('cfs_origCssMargin');
						scrl.anims.push([l_old, a_old]);
					}

					if (pR >= 0) {
						var a_new = {};
							a_new[opts.d['marginLeft']] = l_new.data('cfs_origCssMargin') + opts.padding[opts.d[1]];
				...
				var a_complete = function() {
					...
					if (opts.usePadding) {
						...
						l_itm.css(opts.d['marginLeft'], l_itm.data('cfs_origCssMargin'));
					}
			...
			$cfs.bind(cf_e('slide_next', conf), function(e, sO, nI) {
				...
				if (opts.usePadding) {
					...
					l_new.css(opts.d['marginLeft'], l_new_m);
					...
					var a_cur = {};
						a_cur[opts.d['marginLeft']] = c_new_m;
				...
				var a_complete = function() {
					...
					if (opts.usePadding) {
						if (itms.total < opts.items.visible+nI) {
							...
							l_cur.css(opts.d['marginLeft'], l_cur.data('cfs_origCssMargin') + opts.padding[opts.d[3]]);
						}
						l_itm.css(opts.d['marginLeft'], l_itm.data('cfs_origCssMargin'));
					}
	...
	function sz_resetMargin(i, o, m) {
		...
		i.each(function() {
			var j = $(this);
			var t = parseInt(j.css(o.d['marginLeft']));
			if (isNaN(t)) t = 0;
			j.data('cfs_tempCssMargin', t);
			j.css(o.d['marginLeft'], ((x) ? j.data('cfs_tempCssMargin') : m + j.data('cfs_origCssMargin')));
		});
	}
	function sz_setSizes($c, o, p) {
		...
		if (o.usePadding) {
			...
			var $l = $v.last();
			$l.css(o.d['marginLeft'], $l.data('cfs_origCssMargin') + r);
	...
	function ms_getTrueInnerSize($el, o, dim) {
		...
		var siz = $el[o.d[dim]](),
			arr = (o.d[dim].toLowerCase().indexOf('width') > -1) ? ['paddingRight', 'paddingLeft'] : ['paddingTop', 'paddingBottom'];
