                    ...
                    <div class="tab-container">
                        <div id="tab1" class="tab-content">
                            <ul class="article-list">
                                <?php $subNews = listSubNewsDefault();
                                    if($subNews):
                                	...
                                	<article class="entry-item clearfix">
										<div class="article-thumb">
											<a href="#" class="hover-effect link-icon">
												<img class="responsive-img" src="<?php echo $subNew['img']; ?>" alt="" width="100%" />
											</a>
										</div><!--article-thumb-->
										<div class="entry-content">
                                            <span class="entry-meta">در:&nbsp;</span><a class="meta-data" href="#"><?php echo selectParentNews($subNew['parent']); ?></a>
...
لورم ایپسوم یا طرح‌نما </a></h3>
                                            <p><?php echo $subNew['text']; ?></p>
                                            <a class="more-link" href="#">ادامه مطلب &raquo;</a>
