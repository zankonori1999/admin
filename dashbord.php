                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username"><?php echo $data['name']." ".$data['lastname']; ?></span>
                            <b class="caret"></b>
                        </a>
...
<!--                    // start product management-->
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                            <i class="icon-book"></i>
                            <span>مدیریت سر فصل ها</span>
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=news&p=list">لیست سر فصل ها</a></li>
                            <li><a class="" href="dashbord.php?m=news&p=add">افزودن سر فصل جدید</a></li>
                        </ul>
                    </li>
<!--                    // End product/news management-->

<!--                    // start sub news management-->
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                            <i class="icon-book"></i>
                            <span>مدیریت خبر ها</span>
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=subNews&p=list">لیست خبر ها</a></li>
                            <li><a class="" href="dashbord.php?m=subNews&p=add">افزودن خبر جدید</a></li>
                        </ul>
                    </li>
                    <!--                    // End sub news management-->
<!--                    pages-->
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                            <i class="icon-book"></i>
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=pages&p=list">لیست صفحات ها</a></li>
                            <li><a class="" href="dashbord.php?m=pages&p=add">افزودن صفحه جدید</a></li>
                        </ul>
                    </li>
<!--                    pages-->
...
<!--                    start settings-->
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=settings&p=list">تنضیمات وب سایت </a></li>
                        </ul>
                    </li>
<!--                    End settings-->
